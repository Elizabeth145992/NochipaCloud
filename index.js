...
var storeLocationDataUrl = 'data/NochipaCloud.txt';
        ...
        view: 'Auto',
                ...
                authOptions: {
                   ...
                   /* authType: 'anonymous',
                    ...
                    subscriptionKey: 'odX-yrEubAbJFDMIdb5g2LGjl6YA0_zWvaDBCPGuv7Y'
                }
    });
...
function performSearch() {
    ...
    searchURL.searchFuzzy(atlas.service.Aborter.timeout(3000), query, {
        ...
        if (data.features.length > 0) {
            ...
            document.getElementById('listPanel').innerHTML = '<div class="statusMessage">No se pudo encontrar la dirección que busca.</div>';
        } 
    });
}
...
function updateListItems() {
    ...
    if (camera.zoom < maxClusterZoomLevel) {
        ...
        listPanel.innerHTML = '<div class="statusMessage">Busca una ubicación, haz zoom al mapa, o presiona el botón de "Mi ubicación" para ver ubicaciones individuales.</div>';
       // boton_bot.innerHTML = '<input type="submit" value="Consultar a NochipaCloud" class="btn btn-dark botton_bot" onclick="bot();">';
    } else {
